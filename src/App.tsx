  ...
  return (
    <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
      {user ? (
        ...
        <>
          <div
            className={`min-h-screen w-screen flex items-center justify-center p-4 bg-cover bg-center bg-no-repeat transition-opacity duration-500 opacity-80 absolute inset-0`}
          >
