...
export default function AttendanceOverview({ isLoading }) {
  const attendanceData = [
    { label: "Present", value: 28, color: "bg-green-500", icon: UserCheck },
    { label: "Late", value: 3, color: "bg-yellow-500", icon: Clock },
    { label: "Absent", value: 2, color: "bg-red-500", icon: UserX },
  ];
